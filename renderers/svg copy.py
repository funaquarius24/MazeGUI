...
class SVG(object):
    ...
    def __init__(self, grid, options):
        ...
        # print("page width, height ", page_width, page_height)
    ...
    def image(self):
        ...
        data =  f"""<svg id=\"maze\" width=\"{800}\" height=\"{800}\" stroke-width=\"{self.stroke_width}\" fill-opacity=\"0.0\" stroke=\"#000\">
          <path stroke-linecap=\"round\" 
            d=\"{self.svg}\"></path>
            {self.dots}
         </svg>"""
        print({self.WIDTH * self.dpi})
        print({self.HEIGHT * self.dpi})
        return data
