...
class ColorMaze:
    ...
    def __init__(self, dimensionX=10, dimensionY=10,mazeName = "A_Maze"):
    ...
    def makePP(self,mode = "1", colorWall = 0, colorFloor = 1, pixelSizeOfTile = 10, ):
        ...
        self.pixelSizeOfTile = pixelSizeOfTile
    ...
    def render_maze(self, width, height, **kwargs): 
        ...
        braided = kwargs['braided']
        if 'wall_color' in kwargs and 'floor_color' in kwargs:
            colorWall = kwargs['wall_color']
